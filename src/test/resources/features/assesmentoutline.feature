...
Feature: scenario outline
  ...
  Background: Teacher login
    ...
    Then I type "arthy123@gmail.com" into element with xpath "//input[@formcontrolname='email']"
    Then I type "portnov@1" into element with xpath "//input[@formcontrolname='password']"
